...
**[GET] https://apigateway.serpro.gov.br/consulta-cpf<span id="trialSpanUrl"></span>/<span id="trialSpanVersao"></span>/cpf/99999999999**: chamamos a url da API informando o CPF. No caso a url é "consulta-cpf<span id="trialSpanUrl"></span>/<span id="trialSpanVersao"></span>/cpf/{numero do CPF}"
