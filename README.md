...
**[GET] https://apigateway.serpro.gov.br/consulta-cpf<span id="trialSpanUrl"></span>/v1/cpf/99999999999**: chamamos a url da API informando o CPF. No caso a url é "consulta-cpf/v1/cpf/{numero do CPF}"
